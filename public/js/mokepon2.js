            ...
            .then(function ({ enemigos }) {
                ...
                mokeponesEnemigos= enemigos.map(function (enemigo) {
                    ...
                    if (mokeponNombre === "Hipodoge") {
                        mokeponEnemigo = new Mokepon('Hipodoge','./assets/char2.png',5, './assets/charmander.png', enemigoId)
                    } else if (mokeponNombre === "Capipepo") {
                        mokeponEnemigo = new Mokepon('Capipepo','./assets/squirtle2.png',5, './assets/squirtle.png',enemigoId)
                    } else if (mokeponNombre === "Ratigueya") {
                        mokeponEnemigo = new Mokepon('Ratigueya','./assets/psyduck2.png',5, './assets/psyduck.png',enemigoId)
                    }else if (mokeponNombre === "Picacu") {
                        mokeponEnemigo = new Mokepon('Picacu','./assets/pikachu2.png',5, './assets/pikachu.png',enemigoId)
                    }else if (mokeponNombre === "Bolbasor") {
                        mokeponEnemigo = new Mokepon('Bolbasor','./assets/bolbasor2.png',5, './assets/bullbasaur.png')
                    }
